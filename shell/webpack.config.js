...
module.exports = (env, argv) => {
  ...
  const remotes = isProd
    ? {
        ...
        appTransactions: 'appTransactions@https://mfe-app-transactions.vercel.app/remoteEntry.js',
      }
    : {
        appAccounts: 'appAccounts@http://localhost:3001/remoteEntry.js',
        appTransactions: 'appTransactions@http://localhost:3002/remoteEntry.js',
      };
